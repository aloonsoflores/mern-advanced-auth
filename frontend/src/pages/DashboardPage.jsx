	...
	return (
		...
		>
			...
			<div className='space-y-6'>
				...
				>
					<h3 className='text-xl font-semibold text-green-400 mb-3'>Información de perfil</h3>
				...
				>
					<h3 className='text-xl font-semibold text-green-400 mb-3'>Actividad de la cuenta</h3>
